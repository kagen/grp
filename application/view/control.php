...
<div class="header">
	<div class="headertitle">
		<a href="<?=$root?>index.php"><img src="<?=$root?>images/logo.gif" />アウェイ建築評価ネット株式会社グループウェア</a>
	</div>
	<div class="headerright">
		<a href="<?=$root?>member/edit.php"><?=$realname?></a><?=$administration?>
	...
	<div class="control">
		<table style="border-spacing:0;border-collapse:collapse;"><tr>
			...
			<td<?=$current['forum']?>><a href="<?=$root?>forum/">掲示板</a></td>
