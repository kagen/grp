                ...
                foreach($rowData as $cellValue) {
                    if ($strictNullComparison) {
                        if ($cellValue !== $nullValue) {
                            // Set cell value
                            // change by kagen.yu to keep numbers begin from "0"
                        	if (substr($cellValue, 0, 1) == "0") {
                        		$this->setCellValueExplicit($this->getCell($currentColumn . $startRow)->getCoordinate(), $cellValue, PHPExcel_Cell_DataType::TYPE_STRING);
                        	} else {
