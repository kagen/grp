...
?>
<h1>掲示板<?=$view->caption($hash['folder'], array(0=>'全般'))?></h1>
<ul class="operate">
<?php
...
?>
	...
	<table class="list visited" style="border-spacing:0;border-collapse:collapse;">
		<tr><th><?=$pagination->sortby('forum_title', 'タイトル')?></th>
		<th><?=$pagination->sortby('forum_name', '名前')?></th>
		<th><?=$pagination->sortby('forum_node', 'コメント数')?></th>
		<th><?=$pagination->sortby('forum_lastupdate', 'コメント更新日')?></th>
<?php
