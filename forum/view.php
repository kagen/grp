...
<div class="content">
	<div class="forum">
		...
		<div class="forumproperty">
			<span>閲覧数：<?=$hash['parent']['access_count']?></span>
		...
		<div class="forumcontent">
			<div><?=nl2br($helper->makeClickableLinks($hash['parent']['forum_comment']))?></div>
...
?>
	<div class="forum">
		<div class="forumtitle"><?=$idx.". ".$row['forum_name']?></div>
		<div class="forumedit"><?=$edit?></div>
		<div class="forumproperty"><?=date('Y/m/d H:i:s', strtotime($row['forum_date']))?></div>
		<div class="forumcontent">
			<div><?=nl2br($helper->makeClickableLinks($row['forum_comment']))?></div>
