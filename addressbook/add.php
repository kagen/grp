...
<div class="contentcontrol">
	<h1>アドレス追加</h1>
	<table class="addressbooktype" style="border-spacing:0;border-collapse:collapse;"><tr>
...
<form class="content" method="post" name="addressbook" action="">
	...
	<table class="form" style="border-spacing:0;border-collapse:collapse;">
		...
		<tr><th>メール</th><td><input type="text" name="addressbook_email" class="inputvalue" value="<?=$hash['data']['addressbook_email']?>" /></td></tr>
		<tr><th>会社名</th><td>
