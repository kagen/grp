...
<div class="contentcontrol">
	...
	<table style="border-spacing:0;border-collapse:collapse;"><tr>
		...
		<td><a href="facilityweek.php<?=$calendar->parameter($_GET['year'], $_GET['month'], $_GET['day'])?>">施設</a></td>
	</tr></table>
...
<table class="view" style="border-spacing:0;border-collapse:collapse;">
	...
	<tr><th>タイトル</th><td style="background:<?=$hash['events'][$hash['data']['schedule_event']][1]?>; color:<?=$hash['events'][$hash['data']['schedule_event']][2]?>">（<?=$hash['events'][$hash['data']['schedule_event']][0]?>）&nbsp;<?=$hash['data']['schedule_title']?>&nbsp;</td></tr>
