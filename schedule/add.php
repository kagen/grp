...
<form class="content" method="post" id="schedule" action="">
	...
	<table class="form" style="border-spacing:0;border-collapse:collapse;">
		...
		<tr><th>イベント種類</th><td><?=$helper->selectorColor('schedule_event', $hash['events'], $hash['data']['schedule_event'],'','',true,null,"なし")?></td></tr>
	...
	<input type="hidden" name="owner" value="<?=(isset($hash['member'])?$hash['member']:$_SESSION['userid'])?>" />
</form>
<?php
$view->footing();
?>